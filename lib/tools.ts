...
export const imageTools: Tool[] = [
  ...
  },
  {
    ...
    category: "Image Tools",
    description: "Resize photos and signatures for SSC application upload limits.",
    keywords: ["ssc photo resize", "resize photo for ssc form", "ssc signature resize"],
    government: true,
    icon: FileCheck2,
  },
  {
    name: "RRB Photo Resize",
    slug: "rrb-photo-resize",
    category: "Image Tools",
    description: "Prepare photo and signature files for Railway RRB forms.",
    keywords: ["rrb photo resize", "railway photo resize", "rrb signature resize"],
    government: true,
    icon: TrainFront,
  },
  {
    name: "IBPS Photo Resize",
    slug: "ibps-photo-resize",
    category: "Image Tools",
    description: "Resize banking exam photos and signatures for IBPS uploads.",
    keywords: ["ibps photo resize", "ibps signature resize", "banking exam photo resize"],
    government: true,
    icon: FileImage,
  },
  {
