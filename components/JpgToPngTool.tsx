...
export function JpgToPngTool() {
  ...
  function renderUploadBox() {
    return (
      ...
      >
        <input id="jpg-to-png-upload" ref={fileInputRef} className="sr-only" type="file" accept="image/jpeg,.jpg,.jpeg" multiple onChange={onInputChange} />
  ...
  function renderWorkspacePreview() {
    return (
      <div ref={workAreaRef} data-jpg-to-png-preview-area="true" className="relative min-h-[calc(100vh-9rem)] min-w-0 overflow-visible bg-slate-100 p-4 pt-6 text-left sm:p-6 sm:pt-8">
        <input ref={addMoreInputRef} className="sr-only" type="file" accept="image/jpeg,.jpg,.jpeg" multiple onChange={onAddMoreInputChange} />
  ...
  if (stage === "success" && convertedFiles.length) {
    ...
    return (
      <section
        ...
        data-jpg-to-png-workspace="true"
        id="jpg-to-png-tool"
        className="mx-auto mt-6 w-full max-w-full overflow-visible bg-transparent p-0 text-left"
      >
        <input ref={fileInputRef} className="sr-only" type="file" accept="image/jpeg,.jpg,.jpeg" multiple onChange={onInputChange} />
        <div className="relative min-w-0 overflow-visible bg-slate-100">
          <div data-jpg-to-png-preview-area="true" data-v0-result-screen="true" className="relative min-h-[calc(100vh-9rem)] min-w-0 bg-slate-100 p-4 text-left sm:p-6">
  ...
  if (stage === "workspace" && selectedImages.length) {
    return (
      <section ref={toolSectionRef} data-v0-managed-flow="true" data-jpg-to-png-workspace="true" id="jpg-to-png-tool" onDragOver={onFileDragOver} onDragLeave={onFileDragLeave} onDrop={onUploadDrop} className="mx-auto mt-8 w-full max-w-full scroll-mt-40 overflow-visible border-0 bg-transparent p-0 text-left shadow-none">
