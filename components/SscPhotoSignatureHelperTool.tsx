...
const photoGuidelines = [
  "Live photo must be captured on official SSC website",
...
export function SscPhotoSignatureHelperTool() {
  return (
    <section id="ssc-photo-signature-helper-tool" className="mx-auto mt-6 max-w-6xl text-left">
      <div className="rounded-[2rem] border border-red-200 bg-red-50 p-5 shadow-[0_24px_70px_rgba(255,45,45,0.08)] sm:p-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
          ...
          <div>
            <h2 className="text-2xl font-black tracking-tight text-slate-950">SSC Photo & Signature Helper</h2>
            <p className="mt-2 text-sm font-bold leading-6 text-red-800">
              SSC latest forms may require live photo capture on official SSC website. This helper does not replace SSC live photo capture.
            </p>
            <p className="mt-2 text-sm font-bold leading-6 text-slate-700">
              Always verify latest SSC photo/signature rules from official SSC notification.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-[0_24px_70px_rgba(15,23,42,0.08)] sm:p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-xl font-black text-slate-950">SSC Photo Guidelines</h3>
              <p className="mt-1 text-sm leading-6 text-slate-600">Follow official SSC instructions while capturing or preparing application images.</p>
            </div>
          </div>
        ...
        <div className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-[0_24px_70px_rgba(15,23,42,0.08)] sm:p-6">
          ...
          <div className="mt-5 grid gap-3">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              <p className="mt-1 text-sm font-semibold leading-6 text-slate-600">Upload signature, resize to SSC-style dimensions, compress to required KB, and download.</p>
            </div>
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm font-bold leading-6 text-amber-800">
                  SSC latest forms may require live photo capture on official SSC website. Use this photo resize only where upload photo option is available.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="mt-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h3 className="mt-2 text-2xl font-black tracking-tight text-slate-950">Resize SSC Signature</h3>
          <p className="mx-auto mt-2 max-w-2xl text-sm leading-6 text-slate-600">Prepare signature files for SSC or other government forms that ask for signature upload size limits.</p>
        </div>
        <SignatureResizeTool />
      </div>
      ...
      <div className="mt-10">
        <div className="mx-auto max-w-4xl rounded-[2rem] border border-amber-200 bg-amber-50 p-5 text-center sm:p-6">
          ...
          <p className="mx-auto mt-2 max-w-2xl text-sm font-bold leading-6 text-amber-800">
            SSC latest forms may require live photo capture on official SSC website. Use this photo resize only for old forms, other exams, or portals where uploaded photo is accepted.
          </p>
        </div>
