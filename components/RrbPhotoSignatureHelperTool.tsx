...
export function RrbPhotoSignatureHelperTool() {
  ...
  function renderUploadBox() {
    return (
      ...
      >
        <input id="rrb-signature-upload" ref={fileInputRef} className="sr-only" type="file" accept="image/jpeg,image/png,image/webp,.jpg,.jpeg,.png,.webp" multiple onChange={onInputChange} />
